    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('n', 'Новая задача'), ('p', 'Запланированная задача'), ('i', 'Задача в работе'), ('f', 'Завершенная задача')], default='n', help_text='Статус текущей задачи', max_length=1)),
